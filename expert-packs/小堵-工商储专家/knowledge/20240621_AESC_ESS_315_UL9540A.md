---
source: pdf
raw_file: _raw/20240621_AESC ESS_315_UL9540A.pdf
keywords: ["NON-STANDARD", "NON-USE", "HC-L315A", "图表信息", "图表关键事件时间点"]
summary: UL 9540A Report Report Issued : 2024-06-21
---
...
| 图表编号 | 图表名称 | 时间范围 (分钟) | 功率范围 (W) | 电压范围 (V) | 说明 |
|---------|---------|------------------|--------------|---------------|------|
| Figure 1 | Cell 1 Conditioning (Charge/discharge) Profiles | 0 - 1000 | -600 到 600 | 0 到 4 | 显示了Cell 1的充放电功率与电压随时间变化的曲线，橙色线为功率，蓝色线为电压。 |
| Figure 2 | Cell 2 Conditioning (Charge/discharge) Profiles | 0 - 1000 | -600 到 600 | 0 到 4 | 显示了Cell 2的充放电功率与电压随时间变化的曲线，橙色线为功率，蓝色线为电压。 |
...
*注：以上数据基于图中曲线的近似读取，具体数值为估算值。*

- 接线图：无接线图，未发现端子排列或线缆规格信息。
...
图片中包含两幅图表（Figure 9 和 Figure 10），描述了电池在外部加热条件下的温度和电压变化，但未提供尺寸标注、设备布局、原理流程、接线信息或结构化数据表。  
...
- 横轴：Time, Minutes（0.0 至 80.0）  
- 左纵轴：Temperature, DegreeC（0.0 至 495.0）  
- 右纵轴：Voltage, V（0.0 至 4.5）  
- 曲线标识：  
  - TC01：蓝色实线  
  - TC02：橙色实线  
  - TC03：灰色实线  
...
| 图表 | 时间 (分钟) | 事件 | 温度 (°C) | 电压 (V) |
|------|-------------|------|-----------|----------|
| Figure 9 | ~37.5 | Vent（紫色虚线） | ~165 | ~3.0 |
| Figure 9 | ~59.5 | Thermal Runaway（红色虚线） | ~440 | ~4.3 |
| Figure 10 | ~37.5 | Vent（紫色虚线） | ~165 | ~3.0 |
| Figure 10 | ~59.5 | Thermal Runaway（红色虚线） | ~440 | ~4.3 |

注：温度与电压值基于图表读取，精度受限于图像分辨率。
...
- 原理图/流程图：无原理图或流程图，不适用。

- 数据表格：

| Time, Minutes | TC01 (Temperature, °C) | TC02 (Temperature, °C) | TC03 (Temperature, °C) | TC04 (Temperature, °C) | V1 (Voltage, V) |
|---------------|------------------------|------------------------|------------------------|------------------------|-----------------|
| 0.0           | ~55                    | ~55                    | ~55                    | ~55                    | ~3.5            |
| 10.0          | ~110                   | ~90                    | ~80                    | ~60                    | ~3.5            |
| 20.0          | ~170                   | ~120                   | ~100                   | ~70                    | ~3.5            |
| 30.0          | ~220                   | ~140                   | ~120                   | ~80                    | ~3.5            |
| 40.0          | ~270                   | ~160                   | ~140                   | ~90                    | ~3.5            |
| 50.0          | ~300                   | ~170                   | ~150                   | ~100                   | ~3.5            |
| 60.0          | ~400                   | ~180                   | ~160                   | ~110                   | ~0.5            |
| 70.0          | ~380                   | ~170                   | ~150                   | ~110                   | ~0.5            |
| 80.0          | ~350                   | ~160                   | ~140                   | ~110                   | ~0.5            |
...
<!-- 以下为第24页图片中提取的结构化数据 -->
- 尺寸图/工程图：未发现尺寸标注数值（单位mm），无相关数据可提取。

- 设备布局图：未发现设备布局图，无法描述组件空间位置关系，无相关数据可提取。

- 原理图/流程图：未发现原理图或流程图，无法描述流向、部件名称和功能，无相关数据可提取。

- 数据表格：

| 项目 | 内容 |
|------|------|
| 图片编号 | Figure 13: Sample 1 Post Test Photos |
| 页码 | Page 24 of 34 |
| 项目编号 | Project No. 4791271040 |
| 标准 | UL 9540A, Edition 4 |

- 接线图：未发现接线图，无法描述端子排列和线缆规格，无相关数据可提取。
...
| 项目 | 内容 |
|------|------|
| 图片编号 | Figure 15: Sample 2 Post Test Photos |
| 项目编号 | Project No. 4791271040 |
| 页面 | Page 26 of 34 |
| 标准 | UL 9540A, Edition 4 |
...
<!-- 以下为第30页图片中提取的结构化数据 -->
无尺寸图/工程图，无设备布局图，无原理图/流程图，无数据表格，无接线图。
...
|------|---------|------------------|----------|
| 1 | Carbon Monoxide | CO | 12.896 |
| 2 | Carbon Dioxide | CO₂ | 23.467 |
| 3 | Hydrogen | H₂ | 51.380 |
| 4 | Methane | CH₄ | 4.980 |
| 5 | Ethylene | C₂H₄ | 2.458 |
| 6 | Acetylene | C₂H₂ | 0.243 |
| 7 | Ethane | C₂H₆ | 0.845 |
| 8 | Propane | CH₃CH₂CH₃ | 0.254 |
| 9 | Propylene | C₃H₆ | 1.252 |
| 10 | Propadiene (Allene) | C₃H₄ | 0.005 |
| 11 | Isobutane | CH₃CH(CH₃)CH₃ | 0.012 |
| 12 | Butane | C₄H₁₀ | 0.057 |
| 13 | Isobutylene | C₄H₈ | 0.235 |
| 14 | 1-Butene | C₄H₈ | 0.054 |
| 15 | trans-2-Butene | C₄H₈ | 0.024 |
| 16 | cis-2-Butene | C₄H₈ | 0.034 |
| 17 | Pentane | C₅H₁₂ | 0.086 |
| 18 | trans-2-Pentene | C₅H₁₀ | 0.013 |
| 19 | cis-2-Pentene | C₅H₁₀ | 0.001 |
| 20 | 1,4-Pentadiene | C₅H₈ | 0.000 |
| 21 | Hexane | C₆H₁₄ | 0.004 |
| 22 | 1-Hexene | C₆H₁₂ | 0.018 |
| 23 | Benzene | C₆H₆ | 0.012 |
| 24 | 1-Heptene | C₇H₁₄ | 0.000 |
| 25 | Toluene | C₇H₈ | 0.000 |
| 26 | Styrene | C₈H₈ | 0.000 |
| 27 | Dimethyl Carbonate | C₃H₆O₃ | 1.453 |
| 28 | Ethyl Methyl Carbonate | C₄H₈O₃ | 0.217 |
| 29 | Diethyl Carbonate | C₄H₁₀O₃ | 0.000 |
